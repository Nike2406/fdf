...
/*   Updated: 2021/08/10 12:05:21 by prochell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	show_tab(t_fdf *data)
{
	...
	mlx_string_put(data->mlx_ptr, data->win_ptr, 150, 130, 0x0000ffff, ft_itoa((int)data->y));
	mlx_string_put(data->mlx_ptr, data->win_ptr, 100, 220, 0x0000ffff, "z = ");
	mlx_string_put(data->mlx_ptr, data->win_ptr, 150, 220, 0x0000ffff, ft_itoa((int)data->z));
}
